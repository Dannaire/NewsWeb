              ...
              <div className="flex-shrink max-w-full w-full lg:w-2/3 overflow-hidden">
                <div className="w-full py-3 mb-3">
                  <h2 className="text-gray-800 text-3xl font-bold">
                    <span className="inline-block h-5 border-l-3 border-red-600 mr-2" /> 5 Tips to Save Money Booking Your Next Hotel Room
                  </h2>
                </div>
                  ...
                  <div className="max-w-full w-full px-4">
                    ...
                    <div className="leading-relaxed pb-4">
                      ...
                      <figure className="text-center mb-6">
                        <img className="max-w-full h-auto" src="src/img/dummy/post1.jpg" alt="Image description" />
                      ...
                      <ol className="mb-4">
                        <li className="py-2 mt-6">
                          <div className="pb-4 border-b border-gray-200 dark:border-gray-600 border-dashed">
                            <footer>
                              <img className="w-20 h-20 border border-gray-200 dark:border-gray-700 max-w-full float-left mr-4" src="src/img/avatar2.jpg" alt="avatar" />
                              <div>
                          ...
                          <ul className="ml-12 md:ml-24">
                            <li className="py-2 mt-6">
                              <div className="pb-4 border-b border-gray-200 dark:border-gray-600 border-dashed">
                                <footer>
                                  <img className="w-20 h-20 border border-gray-200 dark:border-gray-700 max-w-full float-left mr-4" src="src/img/avatar.jpg" alt="avatar" />
                                  <div>
                        ...
                        <li className="py-2 mt-6">
                          ...
                          <ul className="ml-12 md:ml-24">
                            <li className="py-2 mt-6">
                              <div className="pb-4 border-b border-gray-200 dark:border-gray-600 border-dashed">
                                <footer>
                                  <img className="w-20 h-20 border border-gray-200 dark:border-gray-700 max-w-full float-left mr-4" src="/img/avatar2.jpgimg/aqsa.jpeg" alt="avatar" />
                                  <div>
                                    <a className="text-lg leading-normal mb-2 font-semibold text-gray-800 dark:text-gray-100" href="#" target="_blank">Carlos vila</a>
                                    <span className="md:float-right text-sm">
                                      <time dateTime="2020-10-27">Oct 27, 2020</time>
              ...
              <div className="flex-shrink max-w-full w-full lg:w-1/3 lg:pl-8 lg:pt-14 lg:pb-8 order-first lg:order-last">
                ...
                <div className="text-sm py-6 sticky">
                  <div className="w-full text-center">
                    <a className="uppercase" href="#">Advertisement</a>
                    <a href="#">
                      <img className="mx-auto" src="img/aqsa.jpeg" alt="advertisement area" />
                    </a>
                  </div>
                </div>
              </div>
