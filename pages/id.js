        ...
        <div className="bg-gray-50 py-4 hidden">
          <div className="xl:container mx-auto px-3 sm:px-4 xl:px-2">
            <div className="mx-auto table text-center text-sm">
              ...
              <a href="#">
                <img src="img/aqsa.jpeg" alt="advertisement area" />
              </a>
            </div>
          </div>
        </div>
                ...
                <div className="flex flex-row flex-wrap -mx-3">
                  <div className="max-w-full w-full px-4">
                    ...
                    <div className="leading-relaxed pb-4">
                      <p className="mb-5">
                        Aenean sodales lacus est, at ultricies augue ele ifend
                        sit amet. <ins>Be yourself</ins> everyone else is
                        already taken, sem mi placerat felis, ac suscip ligula
                        ex id metus. Vivamus aliquet sit amet nisi non faucibus.
                      ...
                      <p className="mb-5">
                        ...
                        sollicitudin dignissim ut vitae ipsum. Proin at
                        imperdiet ante, non blandit mauris. Nullam eu lobortis
                        justo.
                      </p>
                      <p className="mb-5">
                        Fusce vestibulum blandit justo non rhoncus. Maecenas
                        eget felis id orci ultricies frin gilla. Aliquam
                        suscipit enim felis. Praesent arcu dui, rutrum et
                        molestie sed, volutpat auctor lorem. Fusce sit amet
                        libero odio. Integer sed nisl turpis. Integer mollis sed
                        est eget convallis. Interdum et malesuada fames ac ante
                        ipsum primis in faucibus.
                      </p>
                      <p className="mb-5">
                        Fusce elementum placerat tellus id. Nulla sit amet
                        pretium enim, in vehicula ligula. Proin nec malesuada
                        liberoque blandit. Sed condimentum neque ligula, id
                        dapibus enim ornare id. Duis porttitor, risus vehicula
                        convallis sagittis, ligula nisi iaculis libero, sit amet
                        convallis nulla magna non tortor.
                      </p>
                      ...
                      <p className="mb-5">
                        ...
                        himenaeos. Vivamus libero dolor, condimentum eu augue
                        et, placerat tempus risus. Quisque massa purus,
                        ullamcorper eget ipsum et, eleifend suscipit mi. Duis
                        auctor tortor a dui accumsan, sed semper nunc iaculis.
                      </p>
                      ...
                      <p className="mb-5">
                        Mauris eget lectus et nisi commodo tristique. Aenean
                        eget ornare dui. Maecenas bibendum lacus ante, vitae
                      ...
                      <p className="mb-5">
                        ...
                        Duis porttitor, risus vehicula convallis sagittis,
                        ligula nisi iaculis libero.
                      </p>
                      <p className="mb-5">
                        Morbi at lacinia risus. Donec vitae justo sed augue
                        sollicitudin dignissim ut vitae ipsum. Proin at
                            ...
                            <li className="py-2 mt-6">
                              <div className="pb-4 border-b border-gray-200 dark:border-gray-600 border-dashed">
                                <footer>
                                  <img
                                    className="w-20 h-20 border border-gray-200 dark:border-gray-700 max-w-full float-left mr-4"
                                    src="/img/avatar2.jpgimg/aqsa.jpeg"
                                    alt="avatar"
                                  />
                                  <div>
                                    <a
