                ...
                <div className="flex flex-row flex-wrap -mx-3">
                  <div className="max-w-full w-full px-4">
                    ...
                    <div className="leading-relaxed pb-4">
                      ...
                      <h2 className="text-xl leading-normal mb-2 font-semibold text-gray-800 dark:text-gray-100">{result.subheading}</h2>
                      <p className="mb-5">{result.desc}</p>
                      ...
                      <h3 className="text-2xl leading-normal mb-2 font-semibold text-gray-800 dark:text-gray-100">Berita Hari Ini</h3>
                      <p className="mb-5">{result.conten}</p>
                      ...
                      <blockquote className="relative p-4 border-l-4 border-red-700 bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40 mb-4 text-xl">
                        ...
                        <p className="ml-16 mb-4">"News is what somebody somewhere wants to suppress; all the rest is advertising."</p>
                        <footer className="ml-16 text-base">Quote by <cite title="Source Title">Lord Northcliffe</cite></footer>
                      </blockquote>
                      ...
                      <div className="relative flex flex-row items-center justify-between overflow-hidden bg-gray-100 dark:bg-gray-900 dark:bg-opacity-20 mt-12 mb-2 px-6 py-2">
                        <div className="my-4 text-sm">
                          ...
                          <span className="mr-2 md:mr-4">
                            ...
                            </svg> by <a className="font-semibold" href="#">{result.author}</a>
                          </span>
                          {/*date*/}
                    ...
                    <div className="flex flex-wrap flex-row -mx-4 justify-center py-4">
                      <div className="flex-shrink max-w-full px-4 w-1/3 sm:w-1/4 md:w-1/6">
                        <a href="#"><img className="rounded-full border max-w-full h-auto dark:border-gray-700" src={result.image} alt="author" /></a>
                      </div>
                      ...
                      <div id="comment-form" className="mt-12">
                        ...
                        <div>
                          <form action="#" noValidate>
                            ...
                            <div className="mb-6">
                              <div>
                                <input className="form-checkbox h-5 w-5 text-red-500 dark:bg-gray-700 border border-gray-100 dark:border-gray-700 focus:outline-none" id="comment-cookies" name="comment-cookies" type="checkbox" defaultValue="yes" />
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="post-number">
                      <li className="border-b border-gray-100 hover:bg-gray-50">
                        <a className="text-lg font-bold px-6 py-3 flex flex-row items-center" href="#">Perbaiki rutinitas kecantikan Anda dengan Wardah.</a>
                      </li>
                      <li className="border-b border-gray-100 hover:bg-gray-50">
                        <a className="text-lg font-bold px-6 py-3 flex flex-row items-center" href="#">Dapatkan Gaya Anda! Beli Pakaian Terbaru Kami di LAZADA!</a>
                      </li>
                      <li className="border-b border-gray-100 hover:bg-gray-50">
                        <a className="text-lg font-bold px-6 py-3 flex flex-row items-center" href="#">Lebih Banyak Energi Setiap Hari! Cobalah Mizone!</a>
                      </li>
                      <li className="border-b border-gray-100 hover:bg-gray-50">
                        <a className="text-lg font-bold px-6 py-3 flex flex-row items-center" href="#">Samsung solusi praktis untuk kebutuhan sehari-hari Anda.</a>
                      </li>
                    </ul>
                  </div>
                </div>
